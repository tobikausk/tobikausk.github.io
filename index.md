...
Hello! My name is Tobias Kühn. I'm a postdoctoral researcher currently working at the interface of neuroscience and statistical physics.

My current position is at the [Institut de la Vision](https://www.institut-vision.org/en/) in Paris, France, where I work with [Ulisse Ferrari](https://scholar.google.it/citations?user=89XheA0AAAAJ&hl=it). 
...
I am fascinated by how theoretical physics connects seemingly desparate phenomena and thereby deepens their understanding. My works on diagrammatics of non-Gaussian theories, for example, help to reveal the common grounds of the description of obejcts as diverse as simple liquids and neural networks. These connections to the real world mean in particular that theoretical physics is not only beautiful, but also useful in the real world!
